  ...
  var P = {
    ...
    updateSlides: function () {
        ...
        if (
          ...
          if ('auto' === i.slidesPerView) {
            ...
            if (
              ...
              I = e.isHorizontal() ? v(n, 'width', !0) : v(n, 'height', !0);
            else {
              const e = s(a, 'width'),
                t = s(a, 'padding-left'),
                i = s(a, 'padding-right'),
            ...
            (I = (a - (i.slidesPerView - 1) * E) / i.slidesPerView),
              i.roundLengths && (I = Math.floor(I)),
              u[r] && (u[r].style[t('width')] = `${I}px`);
          u[r] && (u[r].swiperSlideSize = I),
            S.push(I),
            i.centeredSlides
              ? ((M = M + I / 2 + C / 2 + E),
                0 === C && 0 !== r && (M = M - a / 2 - E),
      ...
      if (
        ...
        L && e.grid.updateWrapperSize(I, g, t),
        !i.centeredSlides)
      ) {
        const t = [];
