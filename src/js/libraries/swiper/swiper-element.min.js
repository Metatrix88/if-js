...
!(function () {
  ...
  var M = {
    ...
    updateSlides: function () {
        ...
        if (
          ...
          if ('auto' === i.slidesPerView) {
            ...
            if (
              ...
              z = e.isHorizontal() ? v(n, 'width', !0) : v(n, 'height', !0);
            else {
              const e = s(a, 'width'),
                t = s(a, 'padding-left'),
                i = s(a, 'padding-right'),
            ...
            (z = (a - (i.slidesPerView - 1) * E) / i.slidesPerView),
              i.roundLengths && (z = Math.floor(z)),
              u[r] && (u[r].style[t('width')] = `${z}px`);
          u[r] && (u[r].swiperSlideSize = z),
            b.push(z),
            i.centeredSlides
              ? ((C = C + z / 2 + P / 2 + E),
                0 === P && 0 !== r && (C = C - a / 2 - E),
      ...
      if (
        ...
        k && e.grid.updateWrapperSize(z, g, t),
        !i.centeredSlides)
      ) {
        const t = [];
      ...
      events: {
        attachEvents: function () {
          ...
          (e.onTouchStart = _.bind(e)),
            ...
            (e.onClick = D.bind(e)),
            (e.onLoad = $.bind(e)),
            V || (t.addEventListener('touchstart', B), (V = !0)),
            j(e, 'on');
        },
  ...
  function K(e, t) {
    ...
    Object.keys(t)
      ...
      .forEach((s) => {
        void 0 === e[s]
          ? (e[s] = t[s])
          : U(t[s]) && U(e[s]) && Object.keys(t[s]).length > 0
          ? t[s].__swiper__
            ? (e[s] = t[s])
            : K(e[s], t[s])
          : (e[s] = t[s]);
  ...
  function ee(e, t, s) {
    ...
    return (
      'string' == typeof t &&
        void 0 !== s &&
        o.push({ name: t, value: U(s) ? { ...s } : s }),
      o.forEach((e) => {
        const t = Q.filter((t) => 0 === e.name.indexOf(`${t}-`))[0];
        if (t) {
          const s = Z(t),
            i = Z(e.name.split(`${t}-`)[1]);
          void 0 === r[s] && (r[s] = {}),
            !0 === r[s] && (r[s] = { enabled: !0 }),
            (r[s][i] = J(e.value));
        } else {
  ...
  class ne extends se {
    ...
    initialize() {
      ...
      (this.swiperParams = t),
        ...
        this.render(),
        (this.swiper = new X(this.shadowRoot.querySelector('.swiper'), {
          ...(t.virtual
            ? {}
      ...
      (this.passedParams = i),
        ...
        (function (e) {
          ...
          r.includes('loop') &&
            ...
            r.includes('children') && s && c.loop && (x = !0),
            v && m.init() && m.update(!0);
    ...
    static get observedAttributes() {
      return Y.filter((e) => e.includes('_')).map((e) =>
        e
          .replace(/[A-Z]/g, (e) => `-${e}`)
          .replace('_', '')
          .toLowerCase(),
  ...
  'undefined' != typeof window &&
    ...
    'undefined' != typeof window &&
      (window.customElements.get('swiper-container') ||
        window.customElements.define('swiper-container', ne),
