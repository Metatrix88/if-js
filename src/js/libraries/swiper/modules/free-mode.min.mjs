          ...
          if (o < -t.minTranslate()) t.slideTo(t.activeIndex);
            ...
            if (i.freeMode.momentum) {
              if (m.velocities.length > 1) {
                ...
                (t.velocity = n / s),
                  ...
                  Math.abs(t.velocity) < i.freeMode.minimumVelocity &&
                    (t.velocity = 0),
                  (s > 150 || now() - e.time > 300) && (t.velocity = 0);
              } else t.velocity = 0;
              ...
              let d,
                u = !1;
              const f =
                20 * Math.abs(t.velocity) * i.freeMode.momentumBounceRatio;
              let p;
              if (c < t.maxTranslate())
                i.freeMode.momentumBounce
                  ? (c + t.maxTranslate() < -f && (c = t.maxTranslate() - f),
                    (d = t.maxTranslate()),
                    (u = !0),
              ...
              if (
                ...
                if (
                  ...
                  e =
                    o < n ? i.speed : o < 2 * n ? 1.5 * i.speed : 2.5 * i.speed;
                }
