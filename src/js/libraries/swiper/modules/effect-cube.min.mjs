    ...
    setTranslate: () => {
      ...
      p.shadow &&
        (c
          ? ((h = t.wrapperEl.querySelector('.swiper-cube-shadow')),
            h ||
              ((h = createElement('div', 'swiper-cube-shadow')),
              t.wrapperEl.append(h)),
            (h.style.height = `${o}px`))
          : ((h = e.querySelector('.swiper-cube-shadow')),
            h ||
              ((h = createElement('div', 'swiper-cube-shadow')), e.append(h))));
      for (let e = 0; e < a.length; e += 1) {
        ...
        s % 4 == 0
          ...
          : (s - 2) % 4 == 0
          ? ((h = d + 4 * i * d), (u = d))
          : (s - 3) % 4 == 0 && ((h = -d), (u = 3 * d + 4 * d * i)),
          l && (h = -h),
          c || ((m = h), (h = 0));
        const b = `rotateX(${c ? 0 : -o}deg) rotateY(${
          c ? o : 0
        }deg) translate3d(${h}px, ${m}px, ${u}px)`;
        n <= 1 &&
          n > -1 &&
          ((f = 90 * s + 90 * n), l && (f = 90 * -s - 90 * n)),
          (t.style.transform = b),
          p.slideShadows && r(t, n, c);
      }
      if (
        ((s.style.transformOrigin = `50% 50% -${d / 2}px`),
        (s.style['-webkit-transform-origin'] = `50% 50% -${d / 2}px`),
        p.shadow)
      )
        if (c)
          h.style.transform = `translate3d(0px, ${o / 2 + p.shadowOffset}px, ${
            -o / 2
      ...
      const m =
        (n.isSafari || n.isWebView) && n.needPerspectiveFix ? -d / 2 : 0;
