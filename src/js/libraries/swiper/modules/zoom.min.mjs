...
function Zoom(e) {
    ...
    if (((o = !1), (n = !1), c.push(e), !(c.length < 2))) {
      if (((o = !0), (d.scaleStart = h()), !d.slideEl)) {
        ...
        if (
          ...
          (d.imageEl = a),
          (d.imageWrapEl = a
            ? elementParents(d.imageEl, `.${i.containerClass}`)[0]
            : void 0),
          !d.imageWrapEl)
        )
          return void (d.imageEl = void 0);
        d.maxRatio =
          d.imageWrapEl.getAttribute('data-swiper-zoom') || i.maxRatio;
      }
      if (d.imageEl) {
        const [e, t] = (function () {
  ...
  function f(e) {
    ...
    r >= 0 && (c[r] = e),
      c.length < 2 ||
        ...
        (d.scaleMove = h()),
        d.imageEl &&
          ((a.scale = (d.scaleMove / d.scaleStart) * l),
          a.scale > d.maxRatio &&
            (a.scale = d.maxRatio - 1 + (a.scale - d.maxRatio + 1) ** 0.5),
          a.scale < i.minRatio &&
            (a.scale = i.minRatio + 1 - (i.minRatio - a.scale + 1) ** 0.5),
          (d.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`)));
  }
  function x(e) {
    if (!E(e)) return;
    ...
    r >= 0 && c.splice(r, 1),
      o &&
        ...
        (n = !1),
        d.imageEl &&
          ((a.scale = Math.max(Math.min(a.scale, d.maxRatio), i.minRatio)),
          (d.imageEl.style.transitionDuration = `${t.params.speed}ms`),
          (d.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`),
          (l = a.scale),
          (m = !1),
          a.scale > 1 && d.slideEl
            ? d.slideEl.classList.add(`${i.zoomedSlideClass}`)
            : a.scale <= 1 &&
              d.slideEl &&
  ...
  function X(e) {
    if (
      ...
      !(function (e) {
        ...
        return (
          !!e.target.matches(i) ||
          [...t.hostEl.querySelectorAll(i)].filter((t) => t.contains(e.target))
            .length > 0
        );
      })(e)
    )
    ...
    u.isMoved ||
      ...
      (u.startX = getTranslate(d.imageWrapEl, 'x') || 0),
      (u.startY = getTranslate(d.imageWrapEl, 'y') || 0),
    ...
    (u.minX = Math.min(d.slideWidth / 2 - a / 2, 0)),
      (u.maxX = -u.minX),
      (u.minY = Math.min(d.slideHeight / 2 - r / 2, 0)),
      (u.maxY = -u.minY),
    ...
    const s = (i.scale - l) / (d.maxRatio - t.params.zoom.minRatio),
      { originX: o, originY: n } = d;
    (u.currentX =
      u.touchesCurrent.x - u.touchesStart.x + u.startX + s * (u.width - 2 * o)),
      (u.currentY =
        u.touchesCurrent.y -
        u.touchesStart.y +
        u.startY +
  ...
  function y(e) {
    ...
    if (!d.slideEl) {
      ...
      i &&
        ...
        (d.imageEl = i),
        (d.imageWrapEl = i
          ? elementParents(d.imageEl, `.${a.containerClass}`)[0]
          : void 0);
    }
    ...
    t.params.cssMode &&
      ...
      d.slideEl.classList.add(`${a.zoomedSlideClass}`),
      void 0 === u.touchesStart.x && e
        ? ((r = e.pageX), (o = e.pageY))
        : ((r = u.touchesStart.x), (o = u.touchesStart.y));
    const M = 'number' == typeof e ? e : null;
    1 === l && M && ((r = void 0), (o = void 0)),
      (i.scale =
        M || d.imageWrapEl.getAttribute('data-swiper-zoom') || a.maxRatio),
      (l = M || d.imageWrapEl.getAttribute('data-swiper-zoom') || a.maxRatio),
      !e || (1 === l && M)
        ? ((g = 0), (h = 0))
        : ((C = d.slideEl.offsetWidth),
          (w = d.slideEl.offsetHeight),
          (n = elementOffset(d.slideEl).left + s.scrollX),
          (m = elementOffset(d.slideEl).top + s.scrollY),
          (c = n + C / 2 - r),
          (p = m + w / 2 - o),
          (E = d.imageEl.offsetWidth),
          (v = d.imageEl.offsetHeight),
          (f = E * i.scale),
          (x = v * i.scale),
          (X = Math.min(C / 2 - f / 2, 0)),
          (Y = Math.min(w / 2 - x / 2, 0)),
          (y = -X),
          (z = -Y),
          (g = c * i.scale),
          (h = p * i.scale),
          ...
          h < Y && (h = Y),
          h > z && (h = z)),
      M && 1 === i.scale && ((d.originX = 0), (d.originY = 0)),
      (d.imageWrapEl.style.transitionDuration = '300ms'),
      (d.imageWrapEl.style.transform = `translate3d(${g}px, ${h}px,0)`),
  ...
  function M() {
    ...
    if (e.enabled) return;
    e.enabled = !0;
    const { passiveListener: i, activeListenerWithCapture: a } = w();
    t.wrapperEl.addEventListener('pointerdown', v, i),
      t.wrapperEl.addEventListener('pointermove', f, a),
  ...
  function W() {
    ...
    t.wrapperEl.removeEventListener('pointerdown', v, i),
      t.wrapperEl.removeEventListener('pointermove', f, a),
      ['pointerup', 'pointercancel', 'pointerout'].forEach((e) => {
  ...
  Object.defineProperty(t.zoom, 'scale', {
      ...
      t.zoom.enabled &&
        (function () {
          ...
          const r = p.x * i,
            ...
            o = p.y * a,
            n = u.currentY + o;
          0 !== p.x && (i = Math.abs((s - u.currentX) / p.x)),
            0 !== p.y && (a = Math.abs((n - u.currentY) / p.y));
          const l = Math.max(i, a);
          (u.currentX = s), (u.currentY = n);
          const m = u.width * e.scale,
            c = u.height * e.scale;
          (u.minX = Math.min(d.slideWidth / 2 - m / 2, 0)),
            (u.maxX = -u.minX),
            (u.minY = Math.min(d.slideHeight / 2 - c / 2, 0)),
            (u.maxY = -u.minY),
    ...
    Object.assign(t.zoom, { enable: M, disable: W, in: y, out: z, toggle: C });
}
