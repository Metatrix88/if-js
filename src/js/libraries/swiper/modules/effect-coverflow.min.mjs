...
function EffectCoverflow(e) {
  ...
  effectInit({
    ...
    on: r,
    setTranslate: () => {
      const { width: e, height: s, slides: r, slidesSizesGrid: o } = t,
      ...
      for (let e = 0, t = r.length; e < t; e += 1) {
        ...
        if (
          ((effectTarget(a, t).style.transform = b),
          ...
          e || (e = createShadow('coverflow', t, i ? 'left' : 'top')),
            s || (s = createShadow('coverflow', t, i ? 'right' : 'bottom')),
            e && (e.style.opacity = h > 0 ? h : 0),
            s && (s.style.opacity = -h > 0 ? -h : 0);
        }
      }
    },
    setTransition: (e) => {
