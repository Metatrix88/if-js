  ...
  effectInit({
    ...
    setTranslate: () => {
      ...
      for (let s = 0; s < e.length; s += 1) {
        ...
        l ||
          (f = Math.min(
            Math.max(r.originalProgress, -i.limitProgress),
            i.limitProgress,
          ));
        ...
        c < 0 ? ((g = i.next), (h = !0)) : c > 0 && ((g = i.prev), (h = !0)),
          p.forEach((e, t) => {
