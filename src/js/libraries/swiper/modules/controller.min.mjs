    ...
    r('beforeInit', () => {
      if (
        ...
        if (t && t.swiper) e.controller.control = t.swiper;
          ...
          const n = (r) => {
            (e.controller.control = r.detail[0]),
              e.update(),
          ...
          'slide' === e.params.controller.by &&
            (!(function (t) {
              e.controller.spline = e.params.loop
                ? new o(e.slidesGrid, t.slidesGrid)
                : new o(e.snapGrid, t.snapGrid);
            })(t),
            ...
            (s && 'container' !== e.params.controller.by) ||
              ...
              (!Number.isNaN(l) && Number.isFinite(l)) || (l = 1),
              (s = (n - e.minTranslate()) * l + t.minTranslate())),
