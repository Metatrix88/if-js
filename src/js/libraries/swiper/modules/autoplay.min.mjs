...
function Autoplay(e) {
  let a,
    t,
    { swiper: n, extendParams: r, on: i, emit: o, params: s } = e;
  ...
  function w(e) {
    n &&
      ...
      (n.wrapperEl.removeEventListener('transitionend', w), O());
  }
  const E = () => {
    ...
    f = (e) => {
      ...
      !Number.isNaN(i) && i > 0 && void 0 === e && ((r = i), (g = i), (v = i)),
        (p = r);
          ...
          n &&
            ...
            (n.params.autoplay.reverseDirection
              ? !n.isBeginning || n.params.loop || n.params.rewind
                ? (n.slidePrev(s, !0, !0), o('autoplay'))
                : n.params.autoplay.stopOnLastSlide ||
                  (n.slideTo(n.slides.length - 1, s, !0, !0), o('autoplay'))
              : !n.isEnd || n.params.loop || n.params.rewind
              ? (n.slideNext(s, !0, !0), o('autoplay'))
              : n.params.autoplay.stopOnLastSlide ||
    ...
    D = (e, t) => {
      ...
      if (((n.autoplay.paused = !0), t))
        return m && (p = n.params.autoplay.delay), (m = !1), void r();
      const i = p || n.params.autoplay.delay;
      (p = i - (new Date().getTime() - T)),
        (n.isEnd && p < 0 && !n.params.loop) || (p < 0 && (p = 0), r());
    },
    O = () => {
      (n.isEnd && p < 0 && !n.params.loop) ||
        n.destroyed ||
        !n.autoplay.running ||
        ((T = new Date().getTime()),
        c ? ((c = !1), f(p)) : f(),
    ...
    A = () => {
      if (n.destroyed || !n.autoplay.running) return;
      const e = getDocument();
      'hidden' === e.visibilityState && ((c = !0), D(!0)),
        'visible' === e.visibilityState && O();
    },
    F = (e) => {
      'mouse' === e.pointerType &&
        ((c = !0), n.animating || n.autoplay.paused || D(!0));
    },
    S = (e) => {
  ...
  i('init', () => {
    n.params.autoplay.enabled &&
      (n.params.autoplay.pauseOnMouseEnter &&
        (n.el.addEventListener('pointerenter', F),
        n.el.addEventListener('pointerleave', S)),
      getDocument().addEventListener('visibilitychange', A),
      (T = new Date().getTime()),
      b());
  }),
    i('destroy', () => {
      n.el.removeEventListener('pointerenter', F),
        n.el.removeEventListener('pointerleave', S),
        getDocument().removeEventListener('visibilitychange', A),
        n.autoplay.running && L();
    }),
    i('beforeTransitionStart', (e, a, t) => {
      !n.destroyed &&
        n.autoplay.running &&
        (t || !n.params.autoplay.disableOnInteraction ? D(!0, !0) : L());
    }),
    i('sliderFirstMove', () => {
      !n.destroyed &&
        n.autoplay.running &&
    ...
    Object.assign(n.autoplay, { start: b, stop: L, pause: D, resume: O });
}
