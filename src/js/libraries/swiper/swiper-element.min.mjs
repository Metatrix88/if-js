...
class SwiperContainer extends ClassToExtend {
  ...
  calcSlideSlots() {
    const e = this.slideSlots || 0,
      s = [...this.querySelectorAll('[slot^=slide-]')].map((e) =>
  ...
  initialize() {
    ...
    this.initialized = !0;
    const { params: s, passedParams: t } = getParams(this);
    (this.swiperParams = s),
      (this.passedParams = t),
      ...
      (this.swiper = new Swiper(this.shadowRoot.querySelector('.swiper'), {
        ...
        onAny: function (t) {
          ...
          const i = s.eventsPrefix
            ? `${s.eventsPrefix}${t.toLowerCase()}`
            : t.toLowerCase();
          for (
  ...
  updateSwiperOnPropChange(e, s) {
    const { params: t, passedParams: i } = getParams(this, e, s);
    (this.passedParams = i),
      (this.swiperParams = t),
      updateSwiper({
        swiper: this.swiper,
