...
function updateSwiper(e) {
  ...
  if (
    (o.includes('loop') &&
      t.isElement &&
      (d.loop && !n.loop ? (E = !0) : !d.loop && n.loop ? (m = !0) : (x = !0)),
    c.forEach((e) => {
      if (isObject(d[e]) && isObject(n[e]))
        extend(d[e], n[e]),
    ...
    o.includes('children') && i && d.loop && (x = !0),
    b)
  ) {
    f.init() && f.update(!0);
  }
  _ && (t.controller.control = d.controller.control),
    ...
    S &&
      ...
      u.init(),
      u.update()),
    o.includes('allowSlideNext') && (t.allowSlideNext = n.allowSlideNext),
    o.includes('allowSlidePrev') && (t.allowSlidePrev = n.allowSlidePrev),
    o.includes('direction') && t.changeDirection(n.direction, !1),
    (E || x) && t.loopDestroy(),
    (m || x) && t.loopCreate(),
    t.update();
}
